...
// GenAsIdentityType returns the identity type of this column.
// A column can be a GENERATED ALWAYS AS IDENTITY or GENERATED BY DEFAULT AS IDENTITY.
func (c *Column) GenAsIdentityType() GeneratedAsIdentityType {
	return c.generatedAsIdentityType
}
